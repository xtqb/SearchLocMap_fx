...
public class SortAdapter extends RecyclerView.Adapter<SortAdapter.ViewHolder> {
    ...
    private List<HttpPersonInfo> mData;
    private Context mContext;

    public SortAdapter(Context context, List<HttpPersonInfo> data) {
    ...
    public void onBindViewHolder(final SortAdapter.ViewHolder holder, final int position) {
        ...
        holder.tvName.setText(this.mData.get(position).getRealName());
        ...
        holder.llContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("msg_Id", mData.get(position).getId());
                intent.putExtra("realName", mData.get(position).getRealName());
                intent.putExtra("org", mData.get(position).getOrgName());
                intent.putExtra("bdNum",mData.get(position).getDeviceNumbers());
     ...
     * @param list
     */
    public void updateList(List<HttpPersonInfo> list){
        this.mData = list;
