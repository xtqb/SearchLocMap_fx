package com.lhzw.searchlocmap.picker;
...
public class PickerScrollView extends View {
	...
	private int lineColor = 0xABABAB;
	private int textColor = 0x3D87DA;
	...
	private void performSelect() {
		if (mSelectListener != null)
			mSelectListener.onSelect(mDataList.get(mCurrentSelected), this);
	}
	...
	private void drawData(Canvas canvas) {
		...
		canvas.drawLine(0, mViewHeight / 2 - mMaxTextSize + 23, mViewWidth,
				mViewHeight / 2 - mMaxTextSize + 23, linePaint);
		canvas.drawLine(0, mViewHeight / 2 + mMaxTextSize - 20, mViewWidth,
				mViewHeight / 2 + mMaxTextSize - 20, linePaint);
		canvas.drawText(content, mViewWidth / 2 + 70, mViewHeight / 2 + 18,
				textPaint);
	...
	public interface onSelectListener {
		void onSelect(Pickers pickers, View view);
	}
