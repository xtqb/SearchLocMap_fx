...
import com.lhzw.searchlocmap.bean.Pickers;

public class PickerScrollView extends View {
	public static final String TAG = "PickerView";
	public static final float MARGIN_ALPHA = 2.8f;// text之间的间距
	public static final float SPEED = 2;
	private static final int mColorText = 0x333333;
	...
	private float mMaxTextAlpha = 355;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mMinTextSize = mMaxTextSize / 1.40f;
		isInit = true;
		invalidate();
	}
	...
	public PickerScrollView(Context context, AttributeSet attrs, int defStyle) {
